...
const lessons: Lesson[] = [
  ...
  },
  {
    ...
    autoCompleteOnQuiz: true,
    quiz: [
      quiz("q-qz-1", "מה חובה אחרי שבינה יצרה בוחן?", ["מפרסמים מיד", "עוברים על השאלות והניקוד", "מוחקים את הכיתה"], 1),
  ...
  },
  {
    ...
    autoCompleteOnQuiz: true,
    quiz: [
      quiz("q-gc-1", "מה כותבים בהוראות ל־GEM מלווה?", ["רק «תהיה נחמד»", "מי הוא, מה המשימה, ושישאל במקום לעשות במקומן", "את סיסמת הכיתה"], 1),
  ...
  },
  {
    ...
    quiz: [
      ...
      quiz("q-gk-2", "מה חשוב בהוראות?", ["שימציא בחופשיות", "שיישען על החומר שצירפתם, וירמוז לפני הפתרון", "שיחליף את המבחן"], 1),
    ],
  },
  {
  ...
  },
  {
    ...
    quiz: [
      ...
      quiz("q-nsl-2", "שקף לא מדויק — מה עושים?", ["משאירים", "חוזרים למתווה או למקור ומתקנים", "מוחקים את המחברת"], 1),
    ],
  },
  {
    id: "lesson-nb-assess",
  ...
  },
  {
    ...
    autoCompleteOnQuiz: true,
    quiz: [
      quiz("q-cg-1", "מה מגדירים במשחק מקרן?", ["רק צבע", "סוג המשחק וניקוד לפי קבוצות", "סיסמת מייל"], 1),
      quiz("q-cg-2", "לפני שמקרינים — מה בודקים?", ["כלום", "שהשאלות מהחומר שצירפתם ומתאימות לגיל", "שרק יש מוזיקה"], 1),
    ],
  },
  {
    ...
    quiz: [
      ...
      quiz("q-cl-2", "איך משתפים?", ["רק על המקרן תמיד", "קישור לתלמידה, והיא שולחת את מסך הסיום", "רק בוואטסאפ כקובץ כבד"], 1),
    ],
  },
  {
    ...
    autoCompleteOnQuiz: true,
    quiz: [
      quiz("q-vid-1", "למה מתאים גוגל וידס כאן?", ["רק לישיבת זום", "לסרטון קצר לשיעור שאפשר לשתף", "רק לעריכת תמונת פרופיל"], 1),
      quiz("q-vid-2", "מה בודקים לפני שיתוף?", ["רק את המוזיקה", "שהתמונות מותרות ואין צילום לא רצוי", "רק את אורך הכותרת"], 1),
    ],
  },
  {
    ...
    autoCompleteOnQuiz: true,
    quiz: [
      quiz("q-ph-1", "כמה תמונות עדיף בשיעור אחד?", ["כמה שיותר", "מעט, כל אחת עם תפקיד ברור", "רק סלפי"], 1),
      quiz("q-ph-2", "מתי לא משתמשים בצילום?", ["אם הוא יפה", "אם יש תלמידה שלא רוצה להופיע", "רק ביום שישי"], 1),
    ],
  },
];

...
const lessons: Lesson[] = [
  ...
  },
  {
    ...
    body: "<p>בגוגל וידס בונות סרטון קצר: תמונות או שקפים, קריינות, ומוזיקה עדינה.</p><p>שומרות ומשתפות קישור עם הכיתה. בודקות שהתמונות מותרות — בלי פנים של תלמידות שלא רוצות.</p>",
    ...
    quiz: [
      ...
      quiz("q-vid-2", "מה בודקות לפני שיתוף?", ["רק את המוזיקה", "שהתמונות מותרות ואין צילום לא רצוי", "רק את אורך הכותרת"], 1),
    ],
  },
  {
    ...
    body: "<p>בוחרות תמונה אחת ברורה שתומכת ברעיון — לא גלריה ארוכה.</p><p>חותכות למה שחשוב, כותבות כיתוב קצר, ולא מעלות תמונות של תלמידות שלא ביקשו להופיע.</p>",
    autoCompleteOnQuiz: true,
    quiz: [
      quiz("q-ph-1", "כמה תמונות עדיף בשיעור אחד?", ["כמה שיותר", "מעט, כל אחת עם תפקיד ברור", "רק סלפי"], 1),
      quiz("q-ph-2", "מתי לא משתמשות בצילום?", ["אם הוא יפה", "אם יש תלמידה שלא רוצה להופיע", "רק ביום שישי"], 1),
    ],
  },
];
